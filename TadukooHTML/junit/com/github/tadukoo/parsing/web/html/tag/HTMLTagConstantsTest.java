...
public class HTMLTagConstantsTest implements HTMLTagConstants{
	...
	@Test
	public void testHTML_INLINE_FRAME_TAG_NAME(){
		assertEquals("iframe", HTML_INLINE_FRAME_TAG_NAME);
	}
	...
	public void testVALID_HTML_BODY_SUB_TAGS(){
		assertEquals(SetUtil.createSet(HTML_HEADING_1_TAG_NAME, HTML_HEADING_2_TAG_NAME,
				...
				HTML_UNORDERED_LIST_TAG_NAME, HTML_ORDERED_LIST_TAG_NAME, HTML_INLINE_FRAME_TAG_NAME),
				VALID_HTML_BODY_SUB_TAGS);
	}
